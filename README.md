# Asia Fall 2026 — Trip Dossier

Mobile-first planning site for the locked November 2026 friends trip:

**Hong Kong → Chongqing → Shanghai → Taipei**, with a conditional same-day Shenzhen VOA outing from Hong Kong.
...
No build step is required. GitHub Pages serves `index.html` from `main`.
